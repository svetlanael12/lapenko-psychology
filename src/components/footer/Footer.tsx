...
export const Footer = observer(() => {
    ...
    return (
        <Container id='contacts'>
            ...
            <a href={whatsappLink} target="_blank"><WhatsappIcon /> WhatsApp</a>
            <a href={telegramLink} target="_blank"><TelegrammIcon /> Telegram</a>
            <a href={phoneLink} target="_blank"><PhoneIcon />{process.env.NEXT_PUBLIC_PHONE_NUMBER}</a>
        </Container>
    );
});
